...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BONE]     = LAYOUT_moonlander(
    ...
    OSM(MOD_LCTL),  KC_F,           KC_LGUI,        KC_LALT,        LT(2,KC_ESCAPE),                KC_PLAY,                 TD(TD_MAC),                     TT(2),          XXXXXXX,        XXXXXXX,        KC_K,           KC_RSHIFT,
  ...
  [SYMBOLS]  = LAYOUT_moonlander(
    ...
    _______,        _______,        DE_UNDS,        DE_LBRC,        DE_RBRC,        DE_CIRC,        XXXXXXX,                 XXXXXXX,        DE_EXLM,        DE_LABK,        DE_RABK,        DE_EQL,         _______,        _______,
    _______,        DE_DEG,         DE_SLSH,        DE_LCBR,        DE_RCBR,        DE_ASTR,        XXXXXXX,                 XXXXXXX,        DE_QUES,        DE_LPRN,        DE_RPRN,        DE_MINS,        DE_AMPR,        DE_AT,
    _______,        DE_BSLS,        DE_DLR,         DE_PIPE,        DE_TILD,        DE_GRV,                                                  DE_PLUS,        DE_PERC,        DE_DQUO,        DE_QUOT,        DE_COLN,        _______,
    _______,        DE_HASH,        _______,        _______,        _______,                        _______,                 _______,                        _______,        _______,        _______,        DE_SCLN,        DE_EURO,
